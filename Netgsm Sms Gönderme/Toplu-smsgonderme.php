...
/*
	...
	KONU : Netgsm apilerini kullanarak toplu sms gönderim işlemi.
...
$gonderNo = ['numara','numara','numara']; // Sms gönderilecek telefon numaraları. bu kısımı virgüller ile istediğiniz kadar uzatabilirsiniz.
      ...
      xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
        <SOAP-ENV:Body>
            <ns3:smsGonder1NV2 xmlns:ns3="http://sms/">
                ...
                <msg>'.$mesaj.'</msg>';
            foreach ($gonderNo as $m) {
             $xml .='<gsm>'.$m.'</gsm>';
            }
            $xml .='<filter>11</filter>
